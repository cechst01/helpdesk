        ...
        <div class="user flx">
            <p>
                ...
                @if(Auth::user()->admin == 1)
                    <a href="{{route('admin-tickets')}}">Administrace</a><span>|</span>
                @endif
...
<div class="container flx aicjsb">
    <p><span>Firma s.r.o.</span> <br />Karla IV. 556/16, Olomouc,  779 00 <br /><strong>t:</strong> <a href="tel:+420777112333">+420 777 112 333</a>, <strong>m:</strong> <a href="mailto:test@email.cz">test@email.cz</a></p>
    <a class="logo" href="/"><img src="{{asset("img/logo.png")}}" alt="Logo"></a>
</div>
</footer>
